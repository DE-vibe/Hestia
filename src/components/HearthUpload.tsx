    ...
    <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6 flex flex-col items-center">
      <div className="w-full flex items-center justify-between mb-4 pb-3 border-b border-stone-100">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-stone-900">Gather the Hearth Kindling</h3>
        </div>
        <span className="text-xs text-stone-500 font-medium bg-stone-50 border border-stone-200 px-2.5 py-1 rounded-lg">
          ZIP Package Upload
        </span>
      </div>
        ...
        <div
          ...
          className={`group relative flex flex-col items-center justify-center p-10 border-2 border-dashed rounded-2xl cursor-pointer transition-all duration-300 ${
            dragActive
              ...
              : "border-stone-200 bg-stone-50/50 hover:bg-stone-50/90 hover:border-orange-400"
          }`}
        >
          ...
          {isLoading ? (
            <div className="flex flex-col items-center py-6">
              ...
              <p className="text-sm font-semibold text-stone-800">Feeding code to Hestia...</p>
              <p className="text-xs text-stone-500 mt-1 font-mono">Unpacking and analyzing package contents</p>
            </div>
          ) : (
            <div className="flex flex-col items-center text-center">
              <div className="p-4 bg-white border border-stone-200 rounded-2xl shadow-sm text-orange-500 group-hover:text-orange-600 group-hover:scale-110 group-hover:border-orange-200 transition-all duration-300 mb-4">
              ...
              <span className="mt-4 px-4 py-2 bg-white hover:bg-orange-50 border border-stone-200 hover:border-orange-200 rounded-xl text-xs font-semibold text-stone-700 transition shadow-xs">
      ...
      {error && (
        <div className="w-full mt-4 flex items-start gap-2.5 p-3.5 bg-red-50 border border-red-100 rounded-xl text-red-700 text-xs leading-relaxed">
      ...
      {/* Helpful Hint banner */}
      <div className="w-full mt-4 bg-orange-50/40 border border-orange-100/50 rounded-xl p-3.5 flex items-start gap-3">
        <HelpCircle className="w-4.5 h-4.5 text-orange-600 shrink-0 mt-0.5" />
        <div className="text-xs text-stone-600 leading-relaxed">
          <span className="font-semibold text-orange-800">How to export from AI Studio:</span> Open your AI Studio app project, open the settings/export menu (top-right gear icon or export options), select "Export to ZIP", download the ZIP package, and upload it right here.
        </div>
      </div>
    </div>
  );
